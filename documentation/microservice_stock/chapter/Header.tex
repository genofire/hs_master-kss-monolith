...
\usepackage{framed}					% Hintergrundfarben für Boxen
...
\ifoot{\normalfont Warenwirtschaft MM / Go-Team}
\cfoot{}
\ofoot{\normalfont \pagemark}
...
\hypersetup{
	...
	pdfkeywords = {Hochschule Bremen, Masterstudiengang Komplexe Softwaresysteme, Softwarearchitektur, Go}
}
